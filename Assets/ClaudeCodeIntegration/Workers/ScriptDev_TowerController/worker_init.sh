...
echo "=========================================="
echo "Claude Code Worker: ScriptDev_TowerController"
echo "=========================================="
...
echo ""
echo "Worker 'ScriptDev_TowerController' is ready!"
echo "Available Unity commands: unity_help"
echo ""

# Show initial context if provided
if [ -n "Create a MonoBehaviour script called 'TowerController' with these requirements:
Tower placement, shooting mechanics, target detection, different tower types, upgrade system
...
echo "Initial Task:"
cat << 'TASK_EOF'
Create a MonoBehaviour script called 'TowerController' with these requirements:
Tower placement, shooting mechanics, target detection, different tower types, upgrade system
...
Worker Name: ScriptDev_TowerController
